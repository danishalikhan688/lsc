...
//API
import { viewAdminClassList, viewAllStudentsList, updateIncident, uploadImagesToS3, getSelectedIncident, getSelectedIncidentLocation, getSelectedIncidentType , addTypes, updateTypes } from '../../../ApiAction/Admin';
//Constants 
...
class AddIncidentTypes extends Component {
    constructor(props) {
        super(props);
        this.state = {
            modalType: '',
            ...
            if (pathname === "/add-incidentType") {
                if (state !== undefined) {
                    if (state || state.activeIncidentLocationId) {
                        ...
                        this.setState({
                            incident_type_id: state.activeIncidentLocationId
                        }, () => {
...
export default connect(mapStateToProps, mapDispatchToProps)(AddIncidentTypes);
